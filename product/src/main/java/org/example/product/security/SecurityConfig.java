...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Lecture publique : les visiteurs peuvent voir les produits et catégories
                ...
                // Toutes les autres routes (commandes, admin, création/suppression produits) nécessitent un token
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Collections.singletonList("http://localhost:3000")); // Or whatever the frontend URL is
